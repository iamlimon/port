    ...
    render() {
      return (
        <nav id="nav">
                ...
                <svg onClick={this.props.onClick} alt="Coding Projects" id="animation" className="nav-icon" id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 44.82 68.71"><title>icon-phone</title><g id="Layer_2" data-name="Layer 2"><g id="Õ_1" data-name="Õ  1"><path class="cls-1" d="M34.46,0H10.36A10.37,10.37,0,0,0,0,10.36v48A10.37,10.37,0,0,0,10.36,68.71h24.1A10.37,10.37,0,0,0,44.82,58.35v-48A10.37,10.37,0,0,0,34.46,0Zm6.36,17.57v33H4v-33ZM10.36,4h24.1a6.36,6.36,0,0,1,6.36,6.36h0v3.21H4V10.36A6.36,6.36,0,0,1,10.36,4Zm24.1,60.71H10.36A6.36,6.36,0,0,1,4,58.35H4V54.6H40.82v3.75a6.36,6.36,0,0,1-6.36,6.36Z"/><path class="cls-1" d="M27.16,57.24h-9.5a2,2,0,0,0,0,4h9.5a2,2,0,1,0,0-4Z"/><path class="cls-1" d="M15.8,11H29a2,2,0,0,0,0-4H15.8a2,2,0,0,0,0,4Z"/></g></g></svg>
         </div>
        </nav>
      );
    }
